 ...
 * @author      Oliver Montes <oliver.montes@devopensource.com>
 * @version     0.1.0
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */

/**
 * Rewrite One page checkout processing model
 * source model: app/code/core/Mage/Checkout/Model/Type/Onepage.php
 */
class Devopensource_TaxVatNumber_Model_Checkout_Type_Onepage extends Mage_Checkout_Model_Type_Onepage
{
    ...
    public function saveBilling($data, $customerAddressId)
    {
       ...
       // if (!Mage::helper('devopentaxvatnumber/data')->isEnabledModule()){
